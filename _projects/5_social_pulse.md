...
description: Real-time trend detection and sentiment analysis from streaming social data using NLP
img: assets/img/projects/social.png
importance: 5
category: Data Engineering
github: https://github.com/sridhar-3009/Real-Time-Social-Pulse-Analyzer
---

NLP-based pipeline to detect trending topics and analyze sentiment from streaming social media
data in real time.
